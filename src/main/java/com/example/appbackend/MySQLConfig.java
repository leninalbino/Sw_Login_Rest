 ...
 * transactionManagerRef = "adminTransactionManager", basePackages = {
 * "com.example.appbackend.repository"}) public class MySQLConfig {
 * 
 * @Autowired private Environment env;
 * 
 * @Bean(name = "adminDataSource") public DataSource userDatasource() {
 ...
 * return dataSource; }
 * 
 * @Bean(name = "adminEntityManagerFactory") public
 * LocalContainerEntityManagerFactoryBean entityManagerFactory() {
 * LocalContainerEntityManagerFactoryBean em = new
 * LocalContainerEntityManagerFactoryBean(); em.setDataSource(userDatasource());
 * em.setPackagesToScan("com.example.appbackend.model");
 * 
 ...
 * }
 * 
 * @Bean(name = "adminTransactionManager") public PlatformTransactionManager
